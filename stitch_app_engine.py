...
SITE_CHROME_TRANSLATIONS: Dict[str, list] = {
    ...
    "mai": [
        ("Live Operations & Orchestrations", "लाइव संचालन आ ऑर्केस्ट्रेशन"),
        ("Performance & Execution Vector", "प्रदर्शन आ निष्पादन वेक्टर"),
        ("Deep Intelligence & Analytics", "गहन इंटेलिजेंस आ एनालिटिक्स"),
        ("Data Records Explorer", "डेटा रिकॉर्ड एक्सप्लोरर"),
        ("Google Stitch Engine", "Google Stitch इंजन"),
        ("Live on Main", "मेन पर लाइव"),
        ("Autonomous Tasks", "स्वायत्त काज"),
        ("Efficiency Score", "दक्षता स्कोर"),
        ("Total Throughput", "कुल थ्रूपुट"),
        ("Saved Arbitrage", "बचत आर्बिट्राज"),
        ("New Transaction", "नव लेनदेन"),
        ("Service / Action", "सेवा / कार्रवाई"),
        ("Cluster / Zone", "क्लस्टर / ज़ोन"),
        ("Export Data", "डेटा निर्यात करु"),
        ("Data Records", "डेटा रिकॉर्ड्स"),
        ("Analytics", "एनालिटिक्स"),
        ("Overview", "अवलोकन"),
        ("Allocation", "आवंटन"),
